...
const TOOLS: Tool[] = [
  { key: 'duplicates', title: 'Duplicate Photos', desc: 'Review with Android protection', icon: 'copy-outline', color: theme.color.brand, route: '/duplicates', section: 'Storage' },
  { key: 'large', title: 'Large Files', desc: 'Review real device files', icon: 'folder-open-outline', color: theme.color.info, route: '/large-files', section: 'Storage' },
  { key: 'cache', title: 'App Storage', desc: 'Manage caches safely', icon: 'trash-outline', color: theme.color.warning, route: '/junk', section: 'Storage' },
  { key: 'battery', title: 'Battery', desc: 'Live level and Android controls', icon: 'battery-charging-outline', color: '#F59E0B', route: '/(tabs)/insights', section: 'Performance' },
  { key: 'memory', title: 'Memory Guidance', desc: 'Use Android app controls', icon: 'hardware-chip-outline', color: '#8B5CF6', route: '/(tabs)/insights', section: 'Performance' },
  { key: 'security', title: 'Security Settings', desc: 'Open protected Android checks', icon: 'shield-checkmark-outline', color: theme.color.brand, route: '/(tabs)/insights', section: 'Protection' },
];
          ...
          <Pressable style={styles.featured} onPress={() => router.push('/smart-scan')} testID="featured-smart-scan">
            ...
            <View style={styles.featuredContent}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.featuredTitle}>Smart Storage Check</Text>
                <Text style={styles.featuredBody}>Measure real storage and DevicePulse cache without touching personal files.</Text>
              </View>
